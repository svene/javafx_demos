...
/**
 * As 'TablePopulation2Demo' but using 'LazyCollections.newObservableList()' instead of ' FXCollections.observableArrayList'.
...
public class TablePopulation3Demo extends Application {
	...
	public void start(final Stage stage) throws Exception {
		...
		ObservableList<Integer> items = LazyCollections.newObservableList(LazyCollections.integerItems(1_000_000));  // <== instead of ' FXCollections.observableArrayList'
